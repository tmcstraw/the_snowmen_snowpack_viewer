...
require([
  ...
  "dojo/domReady!"
      ...
      var gpUrl2 = "http://geoserver2.byu.edu/arcgis/rest/services/The_SnowMen_FS/BufferPoints/GPServer/BufferPoints";
      ...
      function completeCallback2(result){
            hide_buttons()
            gp2.getResultData(result.jobId, "BufferedPoints_shp").then(drawResult, drawResultErrBack);
	    }
