...
# from ..app import TheSnowmenSnowpackViewer
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.the_snowmen_snowpack_viewer"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.the_snowmen_snowpack_viewer.tests.tests"

        To run tests in the TheSnowmenSnowpackViewerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.the_snowmen_snowpack_viewer.tests.tests.TheSnowmenSnowpackViewerTestCase"

        To run only the test_if_tethys_platform_is_great function in the TheSnowmenSnowpackViewerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.the_snowmen_snowpack_viewer.tests.tests.TheSnowmenSnowpackViewerTestCase.test_if_tethys_platform_is_great"
...
class TheSnowmenSnowpackViewerTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(TheSnowmenSnowpackViewer)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(TheSnowmenSnowpackViewer)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/the-snowmen-snowpack-viewer/')  # The final '/' is essential for all pages/controllers
